...
const OrderForm = ({serviceId}) => {
    ...
    return (
        <div className="order-form">
            ...
            <div className={"order-form__step"}>
                <p className={"order-form__step_info__number"}>{serviceId ? "01" : "02"}</p>
                ...
                <input className={"order-from__input"} type="tel" placeholder={"+7 (999)-999-99-99"}
                       onChange={e => handlePhoneChange(e, setPhone)} onBlur={e => onBlurPhoneHandler(e, setPhoneDirty)} value={phone}/>
                {emailError
            ...
            <div className={"order-form__step"}>
                <p className={"order-form__step_info__number"}>{serviceId ? "02" : "03"}</p>
