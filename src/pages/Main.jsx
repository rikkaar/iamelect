...
import pic1 from "@assets/IMG_1183.jpg"
            ...
            <div className={"content"}>
                <section className={"welcome container"}>
                    ...
                    <div className={"grid3 welcome__grid"}>
                        <Scroll spy={true} smooth={true} offset={50} duration={1000} to={"services"}
                                className={"btn-plain welcome__btn btn-font"}>Перейти к услугам</Scroll>
                    </div>
                </section>
                    ...
                    <div className={"about__content section"}>
                        <ul className={"section__list"}>
                            <li className={"section__list__item body1"}>
                                Мне всегда была интересна тема стиля. Я обращала внимание на красиво одетых девушек, но
                                не
                            ...
                            <li className={"section__list__item body1"}>
                                ...
                                нескольких курсов и нескольких лет практики я с уверенностью умею подбирать образы не
                                только
                            ...
                            <li className={"section__list__item body1"}>
                                У меня за спиной обучения в различных школах стиля. Я проанализировала все подходы и
                                вывела
